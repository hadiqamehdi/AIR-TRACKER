...
class CanvasHandler:
    ...
    def add_color_palette(self):
        ...
        button_size = 70
        padding = 10  # Increased padding between buttons
    ...
    def add_tool_buttons(self):
        ...
        tools = [
            ('pen', r"C:\Users\mfabid\OneDrive\Desktop\Ai-Track3\icons\pen.png"),
            ('highlighter', r"C:\Users\mfabid\OneDrive\Desktop\Ai-Track3\icons\highlighter.png"),
            ('eraser', r"C:\Users\mfabid\OneDrive\Desktop\Ai-Track3\icons\eraser.png")
        ]
    ...
    def set_tool(self, tool):
        ...
        if tool == 'eraser':
            ...
            self.canvas.coords(self.cursor, 0, 0, 50, 50)  # Resize cursor for eraser
        elif tool == 'pen':
            self.current_color = 'black'  # Default pen color
            self.canvas.itemconfig(self.cursor, fill='black')  # Update the cursor to black
            self.canvas.coords(self.cursor, 0, 0, 10, 10)  # Resize cursor for pen
            ...
            self.canvas.coords(self.cursor, 0, 0, 50, 50)  # Resize cursor for highlighter
